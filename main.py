# ==============================================
# Hybrid Signal Bot - نسخه جامع (بدون هوش مصنوعی)
# ==============================================
import os
import time
import logging
...
class HybridTradingSystem:
    ...
    def process_symbol(self, symbol: str):
        try:
            ...
            # ارسال مستقیم سیگنال پس از تایید قوانین تکنیکال بدون نیاز به هوش مصنوعی
